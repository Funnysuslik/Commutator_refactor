...
#define INA233_CLEAR_FAULTS_SIZE          0 /* N/A */
#define INA233_RESTORE_DEFAULT_ALL_SIZE   0 /* N/A */
#define INA233_CAPABILITY_SIZE            1 /* 0xB0 */
#define INA233_IOUT_OC_WARN_LIMIT_SIZE    2 /* 0x7FF8 */
#define INA233_VIN_OV_WARN_LIMIT_SIZE     2 /* 0x7FF8 */
#define INA233_VIN_UV_WARN_LIMIT_SIZE     2 /* 0x0000 */
#define INA233_PIN_OP_WARN_LIMIT_SIZE     2 /* 0x7FF8 */
#define INA233_STATUS_BYTE_SIZE           1 /* 0x00 */
#define INA233_STATUS_WORD_SIZE           2 /* 0x1000 */
#define INA233_STATUS_IOUT_SIZE           1 /* 0x00 */
#define INA233_STATUS_INPUT_SIZE          1 /* 0x00*/
#define INA233_STATUS_CML_SIZE            1 /* 0x00 */
#define INA233_STATUS_MFR_SPECIFIC_SIZE   1 /* 0x20 */
#define INA233_READ_EIN_SIZE              6 /* 0x00/00/00/00/00/00 */
#define INA233_READ_VIN_SIZE              2 /* 0x0000 */
#define INA233_READ_IN_SIZE               2 /* 0x0000 */
#define INA233_READ_VOUT_SIZE             2 /* 0x0000 */
#define INA233_READ_IOUT_SIZE             2 /* 0x0000 */
#define INA233_READ_POUT_SIZE             2 /* 0x0000 */
#define INA233_READ_PIN_SIZE              2 /* 0x0000 */
#define INA233_MFR_ID_SIZE                2 /* 0x54/49 */
#define INA233_MFR_MODEL_SIZE             6 /* 0x49/4E/41/32/33/33h */
#define INA233_MFR_REVISION_SIZE          2 /* 0x41/30 */
#define INA233_MFR_ADC_CONFIG_SIZE        2 /* 0x4127 */
#define INA233_MFR_READ_VSHUNT_SIZE       2 /* 0x0000 */
#define INA233_MFR_ALERT_MASK_SIZE        1 /* 0xF0 */
#define INA233_MFR_CALIBRATION_SIZE       2 /* 0x0001 */
#define INA233_MFR_DEVICE_CONFIG_SIZE     1 /* 0x02 */
#define INA233_CLEAR_EIN_SIZE             0 /* N/A */
#define INA233_TI_MFR_ID_SIZE             2 /* ASCII TI, 0x5449 */
#define INA233_TI_MFR_MODEL_SIZE          2 /* ASCII 33 */
#define INA233_TI_MFR_REVISION_SIZE       2 /* ASCII A0 */
...
#define INA233_DEFAULT_MaxCurrent 10.0f
#define INA233_DEFAULT_RShunt 0.001f
...
#endif
#define INA233_ADDRESS_40H          0x80 /*0b1000000  (A1=GND A2=GND) */
#define INA233_ADDRESS_41H          0x81 /*0b1000001  (A1=GND A2=VDD) */
#define INA233_ADDRESS_42H          0x82 /*0b1000010  (A1=GND A2=SDA) */
#define INA233_ADDRESS_43H          0x83 /*0b1000011  (A1=GND A2=SCL) */
#define INA233_ADDRESS_44H          0x84 /*0b1000100  (A1=VDD A2=GND) */
#define INA233_ADDRESS_45H          0x85 /*0b1000101  (A1=VDD A2=VDD) */
#define INA233_ADDRESS_46H          0x86 /*0b1000110  (A1=VDD A2=SDA) */
#define INA233_ADDRESS_47H          0x87 /*0b1000111  (A1=VDD A2=SCL) */
#define INA233_ADDRESS_48H          0x88 /*0b1001000  (A1=SDA A2=GND) */
#define INA233_ADDRESS_49H          0x89 /*0b1001001  (A1=SDA A2=VDD) */
#define INA233_ADDRESS_4AH          0x8A /*0b1001010  (A1=SDA A2=SDA) */
#define INA233_ADDRESS_4BH          0x8B /*0b1001011  (A1=SDA A2=SCL) */
#define INA233_ADDRESS_4CH          0x8C /*0b1001100  (A1=SCL A2=GND) */
#define INA233_ADDRESS_4DH          0x8D /*0b1001101  (A1=SCL A2=VDD) */
#define INA233_ADDRESS_4EH          0x8E /*0b1001110  (A1=SCL A2=SDA) */
#define INA233_ADDRESS_4FH          0x8F /*0b1001111  (A1=SCL A2=SCL) */
